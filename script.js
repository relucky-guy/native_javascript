...
const john = Object.create(soldier);  // задаём прототип сразу

// const jonh = {
//     health: 100
// };

// jonh.__proto__ = soldier;  // это старый формат записи прототипного наследования!!!

Object.setPrototypeOf(jonh, soldier);  // задаём прототип постфактом =)
...
//     for (let i = 0; i < 1; i++) {
//         let questionResult = prompt('Are you satisfied with the current result? (true or false)', '');
    
//         while(questionResult == '' || questionResult == null || isNaN(questionResult) || questionResult !== 'true' || questionResult !== 'false') {
//             questionResult = prompt('Are you satisfied with the current result? (true or false)', '');
//         }
...
//             i--;
//             console.log('Come up with an idea, perform an action and get the result');
//         }
//     }
...
// console.log(`${questionResult} - What have I done now?`);
